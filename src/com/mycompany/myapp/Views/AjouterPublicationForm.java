 ...
 * @author Omar
 */
public class AjouterPublicationForm extends BaseForm {
    ...
    public AjouterPublicationForm(Resources res ) {
        ...
        TextField CodePub = new TextField("","entrer le titre");
        CodePub.setUIID("TextFieldBlack");
        addStringValue("CodePub",CodePub);
        
        TextField ContenuPub = new TextField("","entrer le contenu");
        CodePub.setUIID("TextFieldBlack");
        addStringValue("ContenuPub",ContenuPub);
        ...
        addStringValue("",btnAjouter);
         ...
         btnAjouter.addActionListener((e) -> {
            ...
            try {
                ...
                if(CodePub.getText().equals("") || ContenuPub.getText().equals("")) {
                    ...
                    Publication p = new Publication(String.valueOf(CodePub.getText()
                    ).toString(),
                                  String.valueOf(ContenuPub.getText()).toString() )                
                            ;
                               
                    
                     System.out.println("data  publication == "+p);
